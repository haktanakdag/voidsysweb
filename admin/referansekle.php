...
<tr><?=$form->doHidden(array('referansid',0));?>
	<td width='20%'>Referans Ad:</td><td><?=$form->doInput(array('referansad'));?></td>
</tr>
<tr>
	<td width='20%'>Açıklama:</td><td><?=$form->doTextAreaInput(array('aciklama'));?></td>
</tr>
<tr>
