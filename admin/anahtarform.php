...
if (valid!='') {	
    ...
    var kayitformdatastr ='anahtarad=' + anahtarad +'&grup=' + grup +'&ozel=' + ozel;
...
<?php 
$form = new clsForms();
$gruplar = new Listeler();
$dlisteler = $gruplar->ListeBaslikGetirAciklamayaGore("Anahtar_Gruplari");
$dlistedetaylar = $gruplar->listeDetayGetirC($dlisteler->id);
//print_r($dlistedetaylar);
if($islem=='duzenle'){
    $data = new Anahtarlar();
...
<tr>
	<td width='20%'>Grup :</td><td> <?=$form->doSelect(array("grup",'ldaciklama',$ddata->grup),$dlistedetaylar) ?>
</tr>
<tr>
    <?php
    $checked="";
    ...
    ?>
    <td width='20%'>Özel :</td><td><?=$form->doCheckGroup(array(1,'ozel',$checked,'Özel'));?></td>
</tr>
<tr>
