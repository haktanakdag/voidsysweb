	...
	private function save_image(){
		...
		switch($this->image_type){//determine mime type
			case 'image/png': 
                                ...
                                //$transColor=imagecolorallocatealpha($this->new_canvas, 0, 0, 0, 0);
                                //imagecolortransparent($this->new_canvas, $transColor);
                            
                                //$red = imagecolorallocate($this->new_canvas,255, 255, 255);
                             
                                
                            
                                //$back = imagecolorallocate($this->new_canvas, 255, 255, 255);
                                //$border = imagecolorallocate($this->new_canvas, 0, 0, 0);
                                
                                //imagecolortransparent($this->new_canvas, $border);
                                //imagefill($this->new_canvas, 0, 0 ,$border);
                                
                                //imagefilledrectangle($this->new_canvas, 0, 0, - 1, - 1, $back);
                                //imagerectangle($this->new_canvas, 0, 0, - 1,  - 1, $border);
