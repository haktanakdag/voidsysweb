...
<p><b><?php echo "<a href='index.php?lx=detay.php&kayitid=$dy->id'>$dy->kayitad</a>"; ?></b></p>
<hr />
<p><?php 
echo ckeditor_temizle($dy->kayitdetay);
echo "<br>";
echo "<a href='index.php?lx=detay.php&kayitid=$dy->id'>Detay</a>";
?></p>
<?php

$klasor ="../resimler/uploads/".$dy->id."/";
$klasorthumb ="../resimler/uploads/".$dy->id."/thumb/";
